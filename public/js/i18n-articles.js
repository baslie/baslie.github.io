window.articleTranslations = {
  ...
  negolosom: {
    ru: {
      title: 'Не пиши голосовое! — мобильное приложение с локальным распознаванием речи',
      description: 'За 2 дня собрал и выпустил в RuStore Android-приложение: записывает голосовые и расшифровывает их в текст прямо на телефоне — без облака, без интернета, на русском.',
      date: '22 апреля 2026'
    },
    en: {
      title: '«Ne pishi golosovoe!» — Mobile App with On-Device Speech Recognition',
      description: 'Shipped an Android app to RuStore in two days: records voice notes and transcribes them on the device — no cloud, no internet, Russian-language speech.',
      date: 'April 22, 2026'
    }
  },
  ehomestroy: {
    ru: {
      title: 'ЭкоHomeСтрой 2.0 — редизайн сайта строительной компании',
      description: 'Редизайн основного сайта «ЭкоHomeСтрой» — строительство домов и бань из СИП-панелей в Москве и Московской области с 2014 года.',
      date: '21 апреля 2026'
    },
    en: {
      title: 'EcoHomeStroy 2.0 — Construction Company Website Redesign',
      description: 'Redesign of the main website for EcoHomeStroy — SIP-panel home and sauna construction in Moscow and Moscow Region since 2014.',
      date: 'April 21, 2026'
    }
  },
  ...
  nutrilegal: {
    ...
    en: {
      title: 'Nutrilegal — Consulting Company Website for Product Registration',
      description: 'A consulting company that helps with state product registration: dietary supplements, sports nutrition, obtaining certificates — from formulation to certification.',
  ...
  'sandwich-ehomestroy': {
    ...
    en: {
      title: 'EcoHomeStroy — Construction Company Landing Page',
      description: 'A landing page for "EcoHomeStroy" — fast-build construction from sandwich panels in\u00A0Moscow and Moscow Region.',
  ...
  berloga: {
    ...
    en: {
      title: 'How "Berloga" Was Launched and\u00A0How Millions Were Made',
      description: 'This is about a project whose idea came to me several years ago. Now it\u2019s a company with 30 employees, a turnover of 7\u201312 million rubles per month, a well-built customer service, and a solid range of premium eco-products.',
      date: 'April 12, 2022'
    }
  }
};
